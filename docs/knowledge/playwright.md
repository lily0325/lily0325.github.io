...
![1.png](https://s2.loli.net/2025/04/08/8g4Tc5wLiFPlxVk.png)

`ctrl+P`打开vscode命令面板输入`Install Playwright`

![image.png](https://s2.loli.net/2025/04/08/tKj52sgMThOdfWy.png)

![image.png](https://s2.loli.net/2025/04/08/PEBdGuKCTX78DrU.png)

安装好后，侧边栏就有playwright的测试功能了。

![image.png](https://s2.loli.net/2025/04/08/sjQlvJSf5KLwItC.png)

能够直接在vscode中就使用playwright的测试能力。

![image.png](https://s2.loli.net/2025/04/08/752vfbkJV8DOyec.png)